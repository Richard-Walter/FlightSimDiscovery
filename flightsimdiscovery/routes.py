...
from flightsimdiscovery import app, db, bcrypt, mail
from flightsimdiscovery.forms import (RegistrationForm, LoginForm, UpdateAccountForm, PoiCreateForm,
                                        PoiUpdateForm, RequestResetForm, ResetPasswordForm)
